...
public class EmployeeServiceImplTest {
    ...
    public void init() {
        ...
        Employee employee = new Employee(101L, "Anthony", 1000000, "HR");
        Employee employee1 = new Employee(102L, "Robert", 1500000, "TECH");
    ...
    public void getEmployeeTest_runtimeExceptionThrown() {
        ...
        try {
            ...
            assertThat(throwable).isInstanceOf(CustomRuntimeException.class);
            CustomRuntimeException runtimeException = (CustomRuntimeException) throwable;
    ...
    public void saveEmployeesTest_success() {
        Employee saveEmployee = new Employee(102L, "Robert", 1500000, "TECH");
    ...
    public void saveEmployeesTest_recordAlreadyExists_runtimeExceptionThrown() throws Exception {
        ...
        try {
            ...
            assertThat(customRuntimeException.getErrorStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
            assertThat(customRuntimeException.getErrorMessage()).isEqualTo("Record already exists in the System for given Id [" + saveEmployee.getId() + "]");
        }
    }
    ...
    public void saveEmployeesTest_runtimeExceptionThrown() throws Exception {
        ...
        try {
            ...
            assertThat(customRuntimeException.getErrorStatus()).isEqualTo(HttpStatus.INTERNAL_SERVER_ERROR);
            assertThat(customRuntimeException.getErrorMessage()).isEqualTo("Save operation failed!");
        }
    }
    ...
    public void updateEmployeesTest_invalidEmployeeIdProvided_runtimeExceptionThrown() {
        ...
        try {
            ...
            assertThat(customRuntimeException.getErrorStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
            assertThat(customRuntimeException.getErrorMessage()).isEqualTo("Invalid Payload provided, please check if EmployeeId is correct or not.");
        }
    }
    ...
    public void updateEmployeesTest_runtimeExceptionThrown() {
        ...
        try {
            ...
            assertThat(apiRuntimeException).isInstanceOf(CustomRuntimeException.class);
            CustomRuntimeException apiException = (CustomRuntimeException) apiRuntimeException;
